...
const Navbar = () => {
  return (
    <nav className='h-16 bg-[#48A6A7] flex justify-between px-3 items-center text-white '>
      ...
      <ul className='flex justify-center gap-4 items-center'>
        ...
        <li className='flex gap-3 pr-16'>
          <Link href="/shorten"><button className='bg-[#2973B2] rounded-lg shadow-lg p-3 py-1 font-bold'>Try Now</button></Link>
